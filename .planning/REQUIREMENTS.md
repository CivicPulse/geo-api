...
- [x] **REVIEW-03**: Codebase passes performance audit (no N+1 queries, pool sizing correct, no logic errors)
...
- [x] **DEPLOY-06**: GitHub Actions workflow (build → GHCR push with sha-tag → manifest update)

# Requirements Archive: v1.3 Production Readiness & Deployment
...
- [x] **DEPLOY-01**: Multi-stage Dockerfile (uv builder, non-root runtime, exec-form CMD, read-only FS compatible)
...
- [x] **DEPLOY-08**: Database provisioned on shared PostgreSQL instance (dev + prod)
